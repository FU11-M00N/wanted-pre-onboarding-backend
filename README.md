...
[1.서버 구성도](#서버-구성도)<br>
[2.애플리케이션 실행 방법](#애플리케이션-실행-방법)<br>
[3.엔드포인트 호출](#엔드포인트-호출)<br>
[4.데이터베이스 테이블 구조](#데이터베이스-테이블-구조)<br>
[5.API 동작 데모 영상 링크](#api-동작-데모-영상-링크)<br>
[6.구현 방법 및 이유에 대한 설명](#구현-방법-및-이유에-대한-설명)<br>
[7.API 명세](#api-명세)<br>

## 지원자: 문호준

## 서버 구성도
![서버 구성도](https://github.com/FU11-M00N/wanted-pre-onboarding-backend/assets/52348215/fa5591b4-1127-4c26-aea9-5753de11b35e)
<br>
### 기술태그
